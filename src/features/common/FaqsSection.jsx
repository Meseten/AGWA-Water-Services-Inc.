...
const faqsData = [
    ...
    { q: "How is my 'Service Type' and 'Role' determined in the portal?", a: "Your Service Type (e.g., Residential, Commercial) and Role (e.g., customer, admin) are typically determined by the AGWA Account Number you provide during signup (e.g., 'RES-' for Residential customer, 'ADM-' for Admin). If you sign up using social login, email link, or phone without an account number, you might be assigned a default role and service type, which can be updated by contacting customer support with your AGWA account details." },
